...
import { drawLabel, getNodeGraphType, getNodeIcon, getNodeSize } from "./utils";
...
function drawHover(
  ...
  data: PartialButFor<NodeDisplayData, "label" | "size" | "x" | "y" | "color">,
  settings: Settings<NodeType, EdgeType, Attributes>,
): void {
